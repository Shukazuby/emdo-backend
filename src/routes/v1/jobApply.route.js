 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of jobApply
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 *         schema:
 *           type: string
 *         description: Employer can  only approved || declined while Employee can only confirmed || Rejected
 *     responses:
 *       "200":
 *         description: OK
 *         content:
 ...
 * /apply/job:
 *   get:
 *     summary: Get applied jobs by employee
 *     description: Retrieve applied employees jobs application.
 *     tags: [JobApply]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /apply/applied:
 *   get:
 *     summary: Get applied jobs by employers
 *     description:  Employers retrieve their posted jobs applied by employees.
 *     tags: [JobApply]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /apply/confirmed:
 *   get:
 *     summary: Get confirmed jobs by employers
 *     description: Employers retrieve their posted jobs confirmed by employees.
 *     tags: [JobApply]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /apply/completed:
 *   get:
 *     summary: Get completed jobs by employers
 *     description: Employers retrieve completed posted jobs.
 *     tags: [JobApply]
 *     security:
 *       - bearerAuth: []
 *     parameters:
